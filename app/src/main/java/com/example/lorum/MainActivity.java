...
public class MainActivity extends AppCompatActivity {
    ...
    public static Integer getTvSumPlayer1FirstRound;
    public static Integer getTvSumPlayer2FirstRound;
    public static Integer getTvSumPlayer3FirstRound;
    public static Integer getTvSumPlayer4FirstRound;

    String Player1Name = Players.Player1Name;
    String Player2Name = Players.Player2Name;
    String Player3Name = Players.Player3Name;
    String Player4Name = Players.Player4Name;
    ...
    private void setPlayers() {
        ...
        tvPlayer3.setText(Player3Name);
        tvPlayer4.setText(Player4Name);
    ...
    private TextWatcher sum1TextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            getTvSumPlayer1FirstRound = Integer.parseInt(tvSumPlayer1.getText().toString());
    ...
    private TextWatcher sum2TextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            getTvSumPlayer2FirstRound = Integer.parseInt(tvSumPlayer2.getText().toString());
    ...
    private TextWatcher sum3TextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            getTvSumPlayer3FirstRound = Integer.parseInt(tvSumPlayer3.getText().toString());
    ...
    private TextWatcher sum4TextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            getTvSumPlayer4FirstRound = Integer.parseInt(tvSumPlayer4.getText().toString());
    ...
    public void jumpToSecondRound(View view) {
        startActivity(new Intent(getApplicationContext(), SecondRound.class));
    }

    public void saveAndReset(View view) {
        tvSumPlayer1.setText("0");
        tvSumPlayer2.setText("0");
        tvSumPlayer3.setText("0");
        tvSumPlayer4.setText("0");

        tvSlagalicaPlayer1.setText("0");
        etCKPlayer1.setText("0");
        etCrvenePlayer1.setText("0");
        etDamePlayer1.setText("0");
        etStihoviPlayer1.setText("0");

        tvSlagalicaPlayer2.setText("0");
        etCKPlayer2.setText("0");
        etCrvenePlayer2.setText("0");
        etDamePlayer2.setText("0");
        etStihoviPlayer2.setText("0");

        tvSlagalicaPlayer3.setText("0");
        etCKPlayer3.setText("0");
        etCrvenePlayer3.setText("0");
        etDamePlayer3.setText("0");
        etStihoviPlayer3.setText("0");

        tvSlagalicaPlayer4.setText("0");
        etCKPlayer4.setText("0");
        etCrvenePlayer4.setText("0");
        etDamePlayer4.setText("0");
        etStihoviPlayer4.setText("0");
