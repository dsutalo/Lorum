...
public class ThirdRound extends AppCompatActivity {
    ...
    public Integer getTvSumPlayer1SecondRound = SecondRound.getTvSumPlayer1SecondRound;
    public Integer getTvSumPlayer2SecoundRound = SecondRound.getTvSumPlayer2SecondRound;
    public Integer getTvSumPlayer3SecoundRound = SecondRound.getTvSumPlayer3SecondRound;
    public Integer getTvSumPlayer4SecoundRound = SecondRound.getTvSumPlayer4SecondRound;

    public static Integer getTvSumPlayer1ThirdRound;
    public static Integer getTvSumPlayer2ThirdRound;
    public static Integer getTvSumPlayer3ThirdRound;
    public static Integer getTvSumPlayer4ThirdRound;
    ...
    private TextWatcher sum1TextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (!etStihoviPlayer1.getText().equals("") && !etCrvenePlayer1.getText().toString().equals("")
                ...
                tvSumPlayer1SecoundRound.setText(String.valueOf(tempSum1 + getTvSumPlayer1SecondRound ));
            ...
            getTvSumPlayer1ThirdRound = Integer.parseInt(tvSumPlayer1SecoundRound.getText().toString());
    ...
    private TextWatcher sum2TextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (!etStihoviPlayer2.getText().equals("") && !etCrvenePlayer2.getText().toString().equals("")
                ...
                tvSumPlayer2SecoundRound.setText(String.valueOf(tempSum2 + getTvSumPlayer2SecoundRound ));
            ...
            getTvSumPlayer2ThirdRound = Integer.parseInt(tvSumPlayer2SecoundRound.getText().toString());
    ...
    private TextWatcher sum3TextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (!etStihoviPlayer3.getText().equals("") && !etCrvenePlayer3.getText().toString().equals("")
                ...
                tvSumPlayer3SecoundRound.setText(String.valueOf(tempSum3 + getTvSumPlayer3SecoundRound ));
            ...
            getTvSumPlayer3ThirdRound = Integer.parseInt(tvSumPlayer3SecoundRound.getText().toString());
    ...
    private TextWatcher sum4TextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (!etStihoviPlayer4.getText().equals("") && !etCrvenePlayer4.getText().toString().equals("")
                ...
                tvSumPlayer4SecoundRound.setText(String.valueOf(tempSum4 + getTvSumPlayer4SecoundRound ));
            ...
            getTvSumPlayer4ThirdRound = Integer.parseInt(tvSumPlayer4SecoundRound.getText().toString());
    ...
    public void jumpToFourthRound(View view) {
        startActivity(new Intent(getApplicationContext(), FourthRound.class));
    }
